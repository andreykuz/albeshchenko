...
CREATE TABLE `directory_street` (
  ...
  `id_street` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `directory_street` VALUES ('Лікарняна',1),('Молодіжна',4),('Першотравнева',2),('Радянська',5),('Шевченка',3);
...
CREATE TABLE `directory_village` (
  ...
  `id_village` tinyint(4) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `directory_village` VALUES ('Вербове',5),('Миколо-Гулак',1),('Тарасівка',4),('Тернова',2),('Утішне',3);
...
-- Dump completed on 2013-11-30 12:01:24
