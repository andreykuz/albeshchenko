...
INSERT INTO `house` VALUES (3,1980,2,2,'3'),(4,1970,2,3,'12');
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `land` (
  `idLand` int(11) NOT NULL AUTO_INCREMENT,
  `number` varchar(25) DEFAULT NULL COMMENT 'кадастровый номер',
  `square` float NOT NULL,
  `type` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idLand`),
  UNIQUE KEY `idLand_UNIQUE` (`idLand`),
  UNIQUE KEY `number_UNIQUE` (`number`),
  KEY `fk_type_land_idx` (`type`),
  KEY `fk_type_land_kidx` (`type`),
  CONSTRAINT `fk_type_land` FOREIGN KEY (`type`) REFERENCES `directory_land` (`iddirectory_land`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `land` VALUES (1,'12101000000:02:104:0035',2,'інд. с-во'),(2,'12101000000:02:104:0054',3,'осг'),(3,'12101000000:02:104:0067',4,'т.в.');
...
CREATE TABLE `ownhouse` (
  ...
  CONSTRAINT `fk_house_people` FOREIGN KEY (`id_people`) REFERENCES `people` (`idpeople`) ON UPDATE CASCADE,
...
CREATE TABLE `ownland` (
  ...
  CONSTRAINT `fk_land` FOREIGN KEY (`Land_idLand`) REFERENCES `land` (`idLand`) ON UPDATE CASCADE,
...
CREATE TABLE `people` (
  ...
  `stat` enum('чоловіча','жіноча') DEFAULT 'чоловіча',
...
INSERT INTO `people` VALUES (1,'Петров','Петро','Петрович',NULL,'1990-12-12',NULL,'чоловіча',1,NULL,NULL,NULL),(2,'Іванов','Тарас','Іванович',NULL,'1980-01-12',NULL,'чоловіча',1,NULL,NULL,NULL),(3,'Іванова','Інна','Миколаївна',NULL,NULL,NULL,'жіноча',1,NULL,NULL,NULL);
...
INSERT INTO `pgo` VALUES (11,1,1,1,NULL,NULL,NULL,'3',NULL,NULL,NULL),(12,1,2,1,NULL,NULL,NULL,'4',NULL,NULL,NULL),(13,2,1,2,NULL,NULL,NULL,'5',NULL,NULL,NULL),(16,2,1,1,NULL,NULL,NULL,'6',NULL,NULL,NULL);
...
CREATE TABLE `registration` (
  ...
  `type` tinyint(1) DEFAULT NULL COMMENT 'тип регистрации - \nрегистрации,\nвременная, \nхозяин не проживающий на тер. совета',
  `address` varchar(256) DEFAULT NULL,
  PRIMARY KEY (`id_people`,`datep`,`id_PGO`,`id_nPGO`),
  KEY `fk_reg_people_idx` (`id_people`),
  KEY `fk_reg_pgo_idx` (`id_PGO`,`id_nPGO`),
  CONSTRAINT `fk_reg_pgo` FOREIGN KEY (`id_PGO`, `id_nPGO`) REFERENCES `pgo` (`idPGO`, `nPGO`) ON UPDATE CASCADE,
...
INSERT INTO `registration` VALUES (1,'2000-11-11',11,1,NULL,0,NULL,NULL,NULL,NULL,NULL),(2,'2001-12-12',12,1,NULL,0,NULL,NULL,NULL,NULL,NULL),(3,'2001-12-12',12,1,'2001-12-20',0,NULL,NULL,NULL,NULL,NULL);
...
--
-- Temporary table structure for view `view_land`
--

DROP TABLE IF EXISTS `view_land`;
/*!50001 DROP VIEW IF EXISTS `view_land`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `view_land` (
  `idland` tinyint NOT NULL,
  `number` tinyint NOT NULL,
  `square` tinyint NOT NULL,
  `type_land` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `view_pgo`
--

DROP TABLE IF EXISTS `view_pgo`;
/*!50001 DROP VIEW IF EXISTS `view_pgo`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `view_pgo` (
  `idPGO` tinyint NOT NULL,
  `nPGO` tinyint NOT NULL,
  `village_name` tinyint NOT NULL,
  `street_name` tinyint NOT NULL,
  `num_house` tinyint NOT NULL,
  `num_flat` tinyint NOT NULL,
  `vukl` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
--
-- Final view structure for view `view_land`
--

/*!50001 DROP TABLE IF EXISTS `view_land`*/;
/*!50001 DROP VIEW IF EXISTS `view_land`*/;
...
/*!50001 VIEW `view_land` AS select `land`.`idLand` AS `idland`,`land`.`number` AS `number`,`land`.`square` AS `square`,`directory_land`.`type_land` AS `type_land` from (`land` join `directory_land` on((`land`.`type` = `directory_land`.`type_land`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `view_pgo`
--

/*!50001 DROP TABLE IF EXISTS `view_pgo`*/;
/*!50001 DROP VIEW IF EXISTS `view_pgo`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_pgo` AS select `pgo`.`idPGO` AS `idPGO`,`pgo`.`nPGO` AS `nPGO`,`directory_village`.`village_name` AS `village_name`,`directory_street`.`street_name` AS `street_name`,`pgo`.`num_house` AS `num_house`,`pgo`.`num_flat` AS `num_flat`,`pgo`.`vukl` AS `vukl` from ((`pgo` left join `directory_street` on((`pgo`.`idstreet` = `directory_street`.`id_street`))) left join `directory_village` on((`pgo`.`idvillage` = `directory_village`.`id_village`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2013-12-07 19:19:49
